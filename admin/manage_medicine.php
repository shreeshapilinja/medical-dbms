...
if (isset($_POST['delete'])) {
  ...
  $delete_query = "DELETE FROM MEDICINES WHERE Med_ID='$med_id'";
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" name="med_price" value="<?php echo $med_price; ?>">
  </div>
  <div class="form-group">
    <label for="location_rack">Location Rack</label>
    <input type="text" class="form-control" name="location_rack" value="<?php echo $location_rack; ?>">
  </div>
